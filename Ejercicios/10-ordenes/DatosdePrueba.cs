 ...
 public class DatosdePrueba
 {
    ...
    public void CrearOrden()
    {
        ...
        if (vendedor == null)
        {
            Console.WriteLine("Vendedor no encontado");
            Console.ReadLine();
            return;
        }else {
        ...
        Orden nuevaOrden = new Orden(nuevoCodigo, DateTime.Now, "SPS001" + nuevoCodigo, cliente, vendedor);
        ...
        while (true)
        {
            ...
            Console.WriteLine("Desea continual? s/n");
        ...
        Console.WriteLine("");
        Console.WriteLine("El Subtotal de la orden es de: " + nuevaOrden.Subtotal + " con un impuesto de: " + nuevaOrden.Impuesto + " dando un total de: " + nuevaOrden.Total); 
        Console.ReadLine();
    }
